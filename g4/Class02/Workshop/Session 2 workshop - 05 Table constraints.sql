...
where BusinessEntityId not in (select ID from dbo.BusinessEntity)
...
--delete from [order] where BusinessEntityID = 100

--alter table dbo.BusinessEntity add primary key (ID)
...
-- Try to insert Order for non-existing Business entity
Insert into dbo.[Order] (OrderDate, Status, BusinessEntityId, CustomerId,EmployeeId,TotalPrice,Comment)
select '2019-05-01' as OrderDate, 0 as Status, 7 as BusinessEntityId , 1 as CustomerId , 1 as EmployeeId , 1000 as TotalPrice, N'' as comment
